...
jq -e '.usage_status == 0 and .options.agreetolicense == true and .options.volume == false and .options.newvolumename == true and .options.rebootdelay == true and .options.pidtosignal == true' \
